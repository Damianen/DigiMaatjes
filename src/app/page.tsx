	...
	return (
		<div className="min-h-screen bg-gradient-to-b from-blue-500 via-blue-400 to-blue-300 flex flex-col items-center justify-center">
			...
			<div className="flex gap-12 w-full max-w-[750px]">
				<a
					href="#login"
					className="flex-1 px-12 py-6 text-2xl bg-white text-blue-600 rounded-lg font-semibold hover:bg-blue-50 focus:outline-none focus:ring-4 focus:ring-blue-600 text-center"
				>
					Login
				</a>
				<a
